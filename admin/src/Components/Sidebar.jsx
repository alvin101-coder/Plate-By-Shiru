  ...
  return (
    <div className='w-[22%] min-h-screen border-r-2 border-gray-200 bg-white'>
      <div className='mt-4 px-'>
        <h2 className='text-[32px] font-bold'>Plate By Shiru</h2>
      </div>
      <div className='flex flex-col gap-4 pt-6'>
        ...
        className='flex items-center gap-3 px-6 py-3 border-b-2 border-b-gray-200 text-gray-600 hover:bg-amber-600 hover:text-white w-full text-left'>
